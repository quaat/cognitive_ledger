...
Objects are written before the ref. Crash leftovers may be unreachable but cannot make the ref invalid. The API never acknowledges an advanced ref before durable publication.
